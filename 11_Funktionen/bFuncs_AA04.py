# Die Python-Funktion sum(a, b, c) berechnet die Summe aller
# übergebenen Parameter. Schreiben Sie eine äquivalente Funktion prod,
# die alle Parametermultipliziert.
